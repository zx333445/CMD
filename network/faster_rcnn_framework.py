...
from .roi_head import CascadeRoIHeads,RoIHeads,RRAMRoIHeads
from .transform import GeneralizedRCNNTransform
from .rpn_function import AnchorsGenerator, RPNHead, RegionProposalNetwork
from .ram_head import RAM_Head
...
class RRAMandGRAM(FasterRCNNBase):
    '''RRAM & GRAM'''
    def __init__(self, backbone, num_classes=None,
                 # transform parameter
        ...
        # ramhead注意力模块增强ROI特征
        if box_ramhead is None:
            box_ramhead = RAM_Head(
                feat_channel=256, 
                hidden_channel=128, 
                globalatt = True)
...
class CascadeRCNN(FasterRCNNBase):
    """Cascade RCNN"""
    def __init__(self, backbone, num_classes=None,
                 # transform parameter
                 min_size=800, max_size=1333,      
