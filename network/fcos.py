...
class FCOSHead(nn.Module):
    ...
    def __init__(self, in_channels: int, num_anchors: int, num_classes: int, num_convs: Optional[int] = 4) -> None:
        ...
        self.classification_head = FCOSClassificationHead(in_channels, num_anchors, num_classes, num_convs) # type: ignore
        self.regression_head = FCOSRegressionHead(in_channels, num_anchors, num_convs) # type: ignore
    ...
    def compute_loss(
        ...
        pred_boxes = self.box_coder.decode(bbox_regression, anchors) # type: ignore
        ...
        bbox_reg_targets = self.box_coder.encode(anchors, all_gt_boxes_targets) # type: ignore
...
class FCOSClassificationHead(nn.Module):
    ...
    def __init__(
        ...
        torch.nn.init.constant_(self.cls_logits.bias, -math.log((1 - prior_probability) / prior_probability)) # type: ignore
...
class FCOS(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if anchor_generator is None:
            anchor_sizes = ((32,), (64,), (96,), (128,), (256,))  # equal to strides of multi-level feature map
    ...
    def forward(
        ...
        # 此处因为不使用fpn返回的'0'特征,而增加了p6与p7,因此去掉对应的第一个value
        ...
        if self.training:
            ...
            detections = self.postprocess_detections(split_head_outputs, split_anchors, images.image_sizes) # type: ignore
